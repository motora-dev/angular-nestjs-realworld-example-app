...
describe('Article Edit Controller E2E', () => {
  ...
  describe('POST /api/articles', () => {
    it('should return 201 with created article when valid data is provided', async () => {
      const createdArticle = { ...mockArticle, slug: 'new-article-slug' };
      vi.mocked(prismaAdapter.$transaction).mockResolvedValueOnce([createdArticle, []]);
    ...
    it('should return 422 when title is missing', async () => {
      ...
      expect(body.errors).toEqual(
        expect.arrayContaining([{ field: 'title', code: ERROR_CODE.TITLE_REQUIRED }]),
      );
    });
    ...
    it('should return 422 when description is missing', async () => {
      ...
      const body = await response.json();
      expect(body.errors).toEqual(
        expect.arrayContaining([{ field: 'description', code: ERROR_CODE.DESCRIPTION_REQUIRED }]),
      );
    });
    ...
    it('should return 422 when body is missing', async () => {
      ...
      const body = await response.json();
      expect(body.errors).toEqual(
        expect.arrayContaining([{ field: 'body', code: ERROR_CODE.BODY_REQUIRED }]),
      );
    });
  });
  ...
  describe('PUT /api/articles/:slug', () => {
    it('should return 200 with updated article when user is the author', async () => {
      ...
      vi.mocked(prismaAdapter.article.findUnique).mockResolvedValueOnce(mockArticle);
      vi.mocked(prismaAdapter.$transaction).mockResolvedValueOnce([updatedArticle, []]);
  ...
  describe('DELETE /api/articles/:slug', () => {
    it('should return 204 when article is deleted successfully', async () => {
      vi.mocked(prismaAdapter.article.findUnique).mockResolvedValueOnce(mockArticle);
      vi.mocked(prismaAdapter.$transaction).mockResolvedValueOnce(undefined);
  ...
  describe('POST /api/articles/:slug/favorite', () => {
    it('should return 200 with favorited article', async () => {
      ...
      vi.mocked(prismaAdapter.favorite.create).mockResolvedValueOnce({ userId: 1, articleId: 1 } as any);
  ...
  describe('DELETE /api/articles/:slug/favorite', () => {
    it('should return 200 with unfavorited article', async () => {
      ...
      vi.mocked(prismaAdapter.favorite.delete).mockResolvedValueOnce({ userId: 1, articleId: 1 } as any);
      vi.mocked(prismaAdapter.article.findUnique).mockResolvedValueOnce(mockArticle);
  ...
  describe('POST /api/articles/:slug/comments', () => {
    it('should return 200 with created comment when valid data is provided', async () => {
      ...
      vi.mocked(prismaAdapter.comment.create).mockResolvedValueOnce(mockComment);
    ...
    it('should return 422 when body is missing', async () => {
      ...
      const body = await response.json();
      expect(body.errors).toEqual(
        expect.arrayContaining([{ field: 'body', code: ERROR_CODE.COMMENT_BODY_REQUIRED }]),
      );
    });
  ...
  describe('DELETE /api/articles/:slug/comments/:id', () => {
    it('should return 204 when comment is deleted successfully', async () => {
      vi.mocked(prismaAdapter.comment.findUnique).mockResolvedValueOnce(mockComment);
      vi.mocked(prismaAdapter.comment.delete).mockResolvedValueOnce(mockComment);
    ...
    it('should return 403 when user is not the comment author', async () => {
      ...
      vi.mocked(prismaAdapter.comment.findUnique).mockResolvedValueOnce(otherUserComment);
