...
export type ValidationErrorCode =
  ...
  | typeof ERROR_CODE.EMAIL_INVALID
  | typeof ERROR_CODE.TITLE_REQUIRED
  | typeof ERROR_CODE.DESCRIPTION_REQUIRED
  | typeof ERROR_CODE.BODY_REQUIRED
  | typeof ERROR_CODE.COMMENT_BODY_REQUIRED;
